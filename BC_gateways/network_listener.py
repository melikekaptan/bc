...
class NetworkListener(Thread):
    ...
    def run(self):
        ...
        print('GATEWAY:{} listening for status updates on port {}...'.format(SERVICE_NAME, self.listener_port))
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                self.on_update(status_value, host, int(Chain_Synchronization_port))
