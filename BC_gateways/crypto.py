...
class Crypto:
    ...
    def validate_transaction(transaction):
        ...
        #logging.info('crypto signature {}'.format(transaction.signature))
        #logging.info('crypto public key {}'.format(transaction.public_key))
...
#Crypto().get_key_by_address('GW1234')
